# 🧭 Day 1: The Genomic Compass
**Navigating One Health Bioinformatics | March 16, 2026**
...
* **Conda**: For robust package and environment management.

> ⚠️ **macOS Users:** Remember that macOS defaults to `zsh`. Our Colab and HPC environments will utilize standard `bash`. Pay close attention to syntax differences during the hands-on sessions!
